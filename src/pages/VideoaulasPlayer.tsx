  ...
  return <div className="px-3 py-4 max-w-6xl mx-auto pb-20">
      ...
      <div>
        ...
        {filteredVideos.length === 0 ? <p className="text-muted-foreground text-center py-8">
            ...
            {filteredVideos.map(video => <Card key={video.videoId} className="cursor-pointer hover:scale-[1.02] hover:shadow-lg transition-all border border-border hover:border-accent/50 bg-card group" onClick={() => {
