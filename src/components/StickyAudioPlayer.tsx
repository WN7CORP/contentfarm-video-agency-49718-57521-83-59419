...
const StickyAudioPlayer = ({ isOpen, onClose, audioUrl, title }: StickyAudioPlayerProps) => {
  ...
  return (
    <div className="fixed bottom-20 left-0 right-0 z-30 animate-fade-in-down">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-card border border-border rounded-xl shadow-lg p-4 backdrop-blur-sm bg-card/95">
          <audio
            ref={audioRef}
            src={audioUrl}
