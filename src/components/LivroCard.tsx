...
export const LivroCard = ({ titulo, autor, subtitulo, capaUrl, sobre, onClick }: LivroCardProps) => {
  return (
    <Card
      className="cursor-pointer hover:shadow-2xl transition-all duration-300 overflow-hidden bg-card/50 backdrop-blur-sm border border-accent/20 hover:border-accent/40 hover:scale-[1.02] group"
      onClick={onClick}
    >
